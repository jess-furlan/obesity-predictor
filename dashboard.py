...
if aba == "📈 Visão Geral":
    ...
    fig1 = px.histogram(df_filt, x="Obesity", labels={"Gender": "Gênero", "Obesity": "Nível de Obesidade", "Age_Group": "Faixa Etária"}, color="Gender", facet_col="Age_Group", barmode="group",
