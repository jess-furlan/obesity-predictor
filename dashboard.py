...
if aba == "📈 Visão Geral":
    ...
    st.info("🔎 A faixa de 30-45 anos com histórico familiar positivo é a que apresenta maior incidência de obesidade tipo II e III.")
...
# 💡 Hábitos e Riscos
    ...
    st.warning("📉 Alta exposição a telas e baixa atividade física elevam o risco de obesidade grave.")
    ...
    st.success("✅ O índice de massa corporal (IMC) tem alta correlação com peso e baixa com atividade física.")
